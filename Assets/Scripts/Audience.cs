...
namespace Audience
{
    public class Audience : MonoBehaviour
    {
        ...
        //public GameObject ViewerCameraPos;
        ...
        /*void Update()
        {
            if (UnityEngine.SceneManagement.SceneManager.GetActiveScene().name == "IntroMenu")
            {
        ...
        {
            Audience.instance.StartCoroutine(StartStreamCoroutine());
        }
        public void StopStreaming()
        {
            Audience.instance.StartCoroutine(StopStreamCoroutine());
        }
        ...
        {
            //var audience_ViewerCameraPivot = Audience.instance.ViewerCameraPos.transform;
            ...
            //instance.Camera.position_y = 7;
            //instance.GameObj.GetComponent<AudienceCameraBehaviour>().ViewerCameraPos = audience_ViewerCameraPivot;
